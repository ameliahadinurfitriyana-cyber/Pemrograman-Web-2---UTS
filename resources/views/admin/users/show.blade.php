...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="max-w-lg">
        @csrf
        @method('PUT')
        ...
        <div class="form-control mb-4">
            ...
            <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}" class="input input-bordered w-full @error('name') input-error @enderror" required />
        ...
        <div class="form-control mb-4">
            ...
            <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}" class="input input-bordered w-full @error('email') input-error @enderror" required />
        ...
        <div class="form-control mb-4">
            ...
            <input type="password" id="password" name="password" class="input input-bordered w-full @error('password') input-error @enderror" />
        ...
        <div class="form-control mb-4">
            ...
            <input type="text" id="phone" name="phone" value="{{ old('phone', $user->phone) }}" class="input input-bordered w-full @error('phone') input-error @enderror" required />
