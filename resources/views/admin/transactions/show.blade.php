    ...
    <div class="card w-full max-w-4xl bg-base-100 shadow-xl">
        <div class="card-body">
            ...
            <div class="flex justify-end gap-4 mb-4">
                <div>
                    <p class="mb-2"><strong>Total:</strong> Rp{{ number_format($transaction->total ?? $transaction->grand_total, 0, ',', '.') }}</p>
                    <p class="mb-2"><strong>Discount:</strong> Rp{{ number_format($transaction->discount ?? 0, 0, ',', '.') }}</p>
                    <p class="text-lg"><strong>Grand Total:</strong> <span class="text-success">Rp{{ number_format($transaction->grand_total, 0, ',', '.') }}</span></p>
                </div>
            </div>
